...
// glob(pattern, flags)
// flags: GLOB_MARK GLOB_NOSORT GLOB_NOCHECK GLOB_BRACE GLOB_ONLYDIR 
/* used for search files and folders, search in subfolders, particular format files, search with regular expression eg.*sa* sa* */
